...
export default class ChildComp extends Component {
    ...
    //shouldComponentUpdate de return true yada false dönmek zorunda
    shouldComponentUpdate(nextProps, nextState) {
        console.log("Child shouldComponentUpdate  runned.")

        console.log(nextProps, nextState)
        return (nextState.count % 10) === 0; // int=>true decinal=>false
    }
    /*componentWillUpdate tedavülden kaldırıldı.
    Bunun içinde yapabildiğimiz herşeyi 
    shouldComponentUpdate içerisinde de yapabliriz.*/
    componentWillUpdate(nextProps, nextState) {
        console.log("Child componentWillUpdate  runned.")
    }

    //WillUpdate'ler Render'dan önce DidUpdate'ler Render'dan
    //sonra çalışırlar.
    ...
    render() {
        ...
        return (
            <div>ChildComp
                ...
                <input name='newcount' id='newcount' onChange={this.changeCount}></input>
            </div>
        )
    }
}
